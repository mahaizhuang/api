...
- [1.1. 🌹IT世界](#11-it世界)
  - [1.1.1. 🚘GitHub中文排行榜:GitHub-Chinese-Top-Charts](#111-github中文排行榜github-chinese-top-charts)
  - [1.1.2. 🚘计算机自学指南:cs-self-learning](#112-计算机自学指南cs-self-learning)
  - [1.1.3. 🚘动画图解的数据结构与算法教程:hello-algo](#113-动画图解的数据结构与算法教程hello-algo)
  - [1.1.4. 🚘前端小项目集合:50projects50 天之前](#114-前端小项目集合50projects50-天之前)
  - [1.1.5. 🚘流行的Tailwind CSS组件库:daisyui](#115-流行的tailwind-css组件库daisyui)
  - [1.1.6. 🚘程序员的瑞士军刀:DevToys](#116-程序员的瑞士军刀devtoys)
  - [1.1.7. 🚘黑客工具全家桶:hackingtool](#117-黑客工具全家桶hackingtool)
  - [1.1.8. 🚘Linux系统性能实时监控工具:netdata](#118-linux系统性能实时监控工具netdata)
  - [1.1.9. 🚘开源的 Linux 服务器运维面板:1Panel](#119-开源的-linux-服务器运维面板1panel)
- [1.2. 🌹AI](#12-ai)
  - [1.2.1. 🚘图像生成软件:Fooocus](#121-图像生成软件fooocus)
  - [1.2.2. 🚘下一代换脸器和增强器:facefusion](#122-下一代换脸器和增强器facefusion)
  - [1.2.3. 🚘3D高斯飞溅实时辐射场渲染:gaussian-splatting](#123-3d高斯飞溅实时辐射场渲染gaussian-splatting)
  - [1.2.4. 🚘免费的GPT-4 API:gpt4free-ts](#124-免费的gpt-4-apigpt4free-ts)
- [1.3. 🌹极客工具](#13-极客工具)
  - [1.3.1. 🚘开源笔记工具:AppFlowy](#131-开源笔记工具appflowy)
  - [1.3.2. 🚘微型在线绘图工具:tldraw 27.7k](#132-微型在线绘图工具tldraw-277k)
  - [1.3.3. 🚘优雅的JSON数据可视化工具:jsoncrack.com](#133-优雅的json数据可视化工具jsoncrackcom)
...
###🚘中文个人独立博客网站合集:chinese-independent-blogs
...
![image](https://github.com/mahaizhuang/interesting/assets/43605010/f1e0c33f-cd3b-43fd-a42f-f06ff013152f)
